app.controller("coao-ctrl", function ($scope, $http) {
    var url = "/rest/coao";
    ...
    $scope.create = function () {
        ...
        $http.post(`${url}`, item).then(resp => {
            ...
            $scope.reset();
            sweetalert("Thêm mới cổ áo!");
        }).catch(error => {
            sweetalert("Lỗi thêm mới cổ áo!");
    ...
    $scope.delete = function (item) {
        $http.delete(`${url}/${item.id}`).then(resp => {
            ...
            $scope.reset();
            sweetalert("Xóa cổ áo thành công!");
        }).catch(error => {
            sweetalert("Lỗi xóa cổ áo!");
            console.log("Error", error);
        });
    }
